      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="relative order-2 lg:order-1">
            <Reveal>
              <div className="relative">
                ...
                <div className="absolute -top-6 -right-6 w-32 h-32 bg-primary-100/50 rounded-full mix-blend-multiply filter blur-2xl -z-10 opacity-70"></div>
                <div className="absolute -bottom-10 -left-10 w-48 h-48 bg-accent-100/40 rounded-full mix-blend-multiply filter blur-3xl -z-10 opacity-60"></div>
              </div>
            </Reveal>
          </div>
          ...
          <div className="order-1 lg:order-2">
            <Reveal>
              <div className="inline-flex items-center gap-2 px-3 py-1 bg-primary-50 text-primary-700 rounded-full text-sm font-semibold mb-4 border border-primary-100">
                <graduation-cap className="w-4 h-4" />
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button onClick={onSchedule} className="w-full md:w-auto shadow-lg shadow-primary-900/10">
